...
enum
{
    ...
    QIOT_MBID_UART_SLOW_POLLITV = 13,
    ...
    QIOT_MBID_OTA_INVT = 53,
    QIOT_MBID_UART_FAST_POLLITV = 54,
    QIOT_MBID_EVENT_MUN_FLAG = 55,
    QIOT_MBID_NEW_EVENT_MUN_RANGE = 56,
    QIOT_MBID_NEW_EVENT_MUN_CHANGE = 57,
    QIOT_MBID_MODEL_8BIT_TYPE = 58
};

enum
{
    QIOT_MBID_NEW_MUN_EVENT_MODE = 1,
    QIOT_MBID_NEW_MUN_EVENT_RANGE_MODE = 2,
    QIOT_MBID_NEW_MUN_EVENT_RANGE_MUN_MINI = 3,
    QIOT_MBID_NEW_MUN_EVENT_RANGE_MUN_MAX = 4,
    QIOT_MBID_NEW_MUN_EVENT_CHANGE_MUN = 5,
};
enum
{
    QIOT_MBID_NEW_MUN_SUBTYPE_8BIT_HIGH,
    QIOT_MBID_NEW_MUN_SUBTYPE_8BIT_LOW
};
